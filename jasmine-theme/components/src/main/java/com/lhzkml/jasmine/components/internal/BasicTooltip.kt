...
import com.lhzkml.jasmine.components.TooltipState
...
internal object BasicTooltipStrings {
    @Composable fun label(): String = stringResource(R.string.tooltip_label)

    @Composable fun description(): String = stringResource(R.string.tooltip_description)
}
