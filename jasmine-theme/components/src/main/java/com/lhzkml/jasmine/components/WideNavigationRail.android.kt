 ...
 */
@Immutable
class ModalWideNavigationRailProperties(
    val securePolicy: SecureFlagPolicy = SecureFlagPolicy.Inherit,
    @get:Suppress("GetterSetterNames") val shouldDismissOnBackPress: Boolean = true,
) {
    constructor(
...
internal fun createDefaultModalWideNavigationRailProperties() =
...
private class ModalWideNavigationRailDialogWrapper(
    ...
    ComponentDialog(
        ContextThemeWrapper(
            composeView.context,
            com.lhzkml.jasmine.components.R.style.EdgeToEdgeFloatingDialogWindowTheme,
        )
    ),
