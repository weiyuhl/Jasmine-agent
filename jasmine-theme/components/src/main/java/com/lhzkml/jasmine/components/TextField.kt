...
import com.lhzkml.jasmine.components.TextFieldDefaults.defaultTextFieldColors
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.SimpleTextFieldSample
 *
 * You can control the initial text input and selection:
 *
 * @sample com.lhzkml.jasmine.components.samples.TextFieldWithInitialValueAndSelection
 *
 * Use input and output transformations to control user input and the displayed text:
 *
 * @sample com.lhzkml.jasmine.components.samples.TextFieldWithTransformations
 *
 * You may provide a placeholder:
 *
 * @sample com.lhzkml.jasmine.components.samples.TextFieldWithPlaceholder
 *
 * You can also provide leading and trailing icons:
 *
 * @sample com.lhzkml.jasmine.components.samples.TextFieldWithIcons
 *
 * You can also provide a prefix or suffix to the text:
 *
 * @sample com.lhzkml.jasmine.components.samples.TextFieldWithPrefixAndSuffix
 *
 * To handle the error input state, use [isError] parameter:
 *
 * @sample com.lhzkml.jasmine.components.samples.TextFieldWithErrorState
 *
 * Additionally, you may provide additional message at the bottom:
 *
 * @sample com.lhzkml.jasmine.components.samples.TextFieldWithSupportingText
 *
 * You can change the content padding to create a dense text field:
 *
 * @sample com.lhzkml.jasmine.components.samples.DenseTextFieldContentPadding
 *
 * Hiding a software keyboard on IME action performed:
 *
 * @sample com.lhzkml.jasmine.components.samples.TextFieldWithHideKeyboardOnImeAction
