...
import com.lhzkml.jasmine.components.internal.BasicTooltipBox
import com.lhzkml.jasmine.components.internal.BasicTooltipDefaults
...
import com.lhzkml.jasmine.components.tokens.PlainTooltipTokens
import com.lhzkml.jasmine.components.tokens.RichTooltipTokens
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.PlainTooltipSample
 *
 * If control of when the tooltip is shown is desired please see
 *
 * @sample com.lhzkml.jasmine.components.samples.PlainTooltipWithManualInvocationSample
 *
 * Plain tooltip with caret shown on long press:
 *
 * @sample com.lhzkml.jasmine.components.samples.PlainTooltipWithCaret
 *
 * Plain tooltip with caret shown on long press which is placed below the anchor:
 *
 * @sample com.lhzkml.jasmine.components.samples.PlainTooltipWithCaretBelowAnchor
 *
 * Plain tooltip with caret shown on long press which is placed left of the anchor:
 *
 * @sample com.lhzkml.jasmine.components.samples.PlainTooltipWithCaretLeftOfAnchor
 *
 * Plain tooltip with caret shown on long press which is placed right of the anchor:
 *
 * @sample com.lhzkml.jasmine.components.samples.PlainTooltipWithCaretRightOfAnchor
 *
 * Plain tooltip with caret shown on long press which is placed start of the anchor:
 *
 * @sample com.lhzkml.jasmine.components.samples.PlainTooltipWithCaretStartOfAnchor
 *
 * Plain tooltip with caret shown on long press which is placed end of the anchor:
 *
 * @sample com.lhzkml.jasmine.components.samples.PlainTooltipWithCaretEndOfAnchor
 *
 * Plain tooltip shown on long press with a custom caret:
 *
 * @sample com.lhzkml.jasmine.components.samples.PlainTooltipWithCustomCaret
 *
 * Tooltip that is invoked when the anchor is long pressed:
 *
 * @sample com.lhzkml.jasmine.components.samples.RichTooltipSample
 *
 * If control of when the tooltip is shown is desired please see
 *
 * @sample com.lhzkml.jasmine.components.samples.RichTooltipWithManualInvocationSample
 *
 * Rich tooltip with caret shown on long press:
 *
 * @sample com.lhzkml.jasmine.components.samples.RichTooltipWithCaretSample
 *
 * Rich tooltip shown on long press with a custom caret
 *
 * @sample com.lhzkml.jasmine.components.samples.RichTooltipWithCustomCaretSample
