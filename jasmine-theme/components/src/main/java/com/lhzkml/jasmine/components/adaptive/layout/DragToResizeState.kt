 ...
 *
 * @sample com.lhzkml.jasmine.components.adaptive.samples.SupportingPaneScaffoldSampleWithExtraPaneLevitatedAsBottomSheet
 * @see com.lhzkml.jasmine.components.adaptive.layout.rememberDragToResizeState
 * @see com.lhzkml.jasmine.components.adaptive.layout.AdaptStrategy.Levitate
 * @see com.lhzkml.jasmine.components.adaptive.layout.PaneAdaptedValue.Levitated
 */
@ExperimentalMaterial3AdaptiveApi
@Stable
