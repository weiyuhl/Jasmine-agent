...
import com.lhzkml.jasmine.components.internal.IncreaseVerticalSemanticsBounds
import com.lhzkml.jasmine.components.internal.circularWavyProgressIndicator
import com.lhzkml.jasmine.components.internal.linearWavyProgressIndicator
import com.lhzkml.jasmine.components.tokens.CircularProgressIndicatorTokens
import com.lhzkml.jasmine.components.tokens.LinearProgressIndicatorTokens
import com.lhzkml.jasmine.components.tokens.MotionTokens
import com.lhzkml.jasmine.components.tokens.ProgressIndicatorTokens
 ...
 * @sample com.lhzkml.jasmine.components.samples.LinearWavyProgressIndicatorSample
 *
 * You may also follow the Material guidelines to create a thicker version of this indicator, like
 * in this example:
 *
 * @sample com.lhzkml.jasmine.components.samples.LinearThickWavyProgressIndicatorSample
 */
 ...
 *   The value here represents a DP per seconds, and by default it's matched to the [wavelength] to
 *   render an animation that moves the wave by one wave length per second.
 * @sample com.lhzkml.jasmine.components.samples.IndeterminateLinearWavyProgressIndicatorSample
 */
@Material3ExpressiveApi
@Composable
fun LinearWavyProgressIndicator(
 ...
 *   wave shape.
 * @sample com.lhzkml.jasmine.components.samples.CircularWavyProgressIndicatorSample
 *
 * You may also follow the Material guidelines to create a thicker version of this indicator, like
 * in this example:
 *
 * @sample com.lhzkml.jasmine.components.samples.CircularThickWavyProgressIndicatorSample
 */
@Material3ExpressiveApi
@Composable
 ...
 *   speed may be slightly different, as the [wavelength] can be adjusted to ensure a continuous
 *   wave shape.
 * @sample com.lhzkml.jasmine.components.samples.IndeterminateCircularWavyProgressIndicatorSample
 */
@Material3ExpressiveApi
@Composable
fun CircularWavyProgressIndicator(
