...
import com.lhzkml.jasmine.components.ProgressIndicatorDefaults.drawStopIndicator
 ...
 * example:
 *
 * @sample com.lhzkml.jasmine.components.samples.LinearProgressIndicatorSample
 ...
 * image](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flqdiyyvh-1P-progress-indicator-configurations.png?alt=media)
 *
 * @sample com.lhzkml.jasmine.components.samples.IndeterminateLinearProgressIndicatorSample
 * @param modifier the [Modifier] to be applied to this progress indicator
 * @param color color of this progress indicator
 * @param trackColor color of the track behind the indicator, visible when the progress has not
 *   reached the area of the overall indicator yet
 ...
 * example:
 *
 * @sample com.lhzkml.jasmine.components.samples.CircularProgressIndicatorSample
 * @param progress the progress of this progress indicator, where 0.0 represents no progress and 1.0
 *   represents full progress. Values outside of this range are coerced into the range.
 * @param modifier the [Modifier] to be applied to this progress indicator
 * @param color color of this progress indicator
 ...
 * image](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flqdiyyvh-1P-progress-indicator-configurations.png?alt=media)
 *
 * @sample com.lhzkml.jasmine.components.samples.IndeterminateCircularProgressIndicatorSample
 * @param modifier the [Modifier] to be applied to this progress indicator
 * @param color color of this progress indicator
 * @param strokeWidth stroke width of this progress indicator
 * @param trackColor color of the track behind the indicator, visible when the progress has not
