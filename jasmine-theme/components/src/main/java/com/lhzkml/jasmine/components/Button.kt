...
import com.lhzkml.jasmine.components.internal.animateElevation
import com.lhzkml.jasmine.components.internal.rememberAnimatedShape
import com.lhzkml.jasmine.components.tokens.BaselineButtonTokens
import com.lhzkml.jasmine.components.tokens.ButtonLargeTokens
import com.lhzkml.jasmine.components.tokens.ButtonMediumTokens
import com.lhzkml.jasmine.components.tokens.ButtonSmallTokens
import com.lhzkml.jasmine.components.tokens.ButtonXLargeTokens
import com.lhzkml.jasmine.components.tokens.ButtonXSmallTokens
import com.lhzkml.jasmine.components.tokens.ColorSchemeKeyTokens
import com.lhzkml.jasmine.components.tokens.ElevatedButtonTokens
import com.lhzkml.jasmine.components.tokens.FilledButtonTokens
import com.lhzkml.jasmine.components.tokens.FilledTonalButtonTokens
import com.lhzkml.jasmine.components.tokens.MotionSchemeKeyTokens
import com.lhzkml.jasmine.components.tokens.OutlinedButtonTokens
import com.lhzkml.jasmine.components.tokens.TextButtonTokens
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.ButtonSample
 * @sample com.lhzkml.jasmine.components.samples.ButtonWithIconSample
 *
 * Button that uses a square shape instead of the default round shape:
 *
 * @sample com.lhzkml.jasmine.components.samples.SquareButtonSample
 *
 * Button that utilizes the small design content padding:
 *
 * @sample com.lhzkml.jasmine.components.samples.SmallButtonSample
 *
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.XSmallButtonWithIconSample
 * @sample com.lhzkml.jasmine.components.samples.MediumButtonWithIconSample
 * @sample com.lhzkml.jasmine.components.samples.LargeButtonWithIconSample
 * @sample com.lhzkml.jasmine.components.samples.XLargeButtonWithIconSample
 *
 ...
 * like "Save", "Join now", or "Confirm".
 *
 * @sample com.lhzkml.jasmine.components.samples.ButtonWithAnimatedShapeSample
 *
 * Choose the best button for an action based on the amount of emphasis it needs. The more important
 * an action is, the higher emphasis its button should be.
 * - See [OutlinedButton] for a medium-emphasis button with a border.
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.ElevatedButtonSample
 *
 * Choose the best button for an action based on the amount of emphasis it needs. The more important
 * an action is, the higher emphasis its button should be.
 ...
 * requires visual separation from patterned container.
 *
 * @sample com.lhzkml.jasmine.components.samples.ElevatedButtonWithAnimatedShapeSample
 *
 * Choose the best button for an action based on the amount of emphasis it needs. The more important
 * an action is, the higher emphasis its button should be.
 * - See [Button] for a high-emphasis button without a shadow, also known as a filled button.
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.FilledTonalButtonSample
 *
 * Choose the best button for an action based on the amount of emphasis it needs. The more important
 * an action is, the higher emphasis its button should be.
 * - See [Button] for a high-emphasis button without a shadow, also known as a filled button.
 ...
 * in an onboarding flow. Tonal buttons use the secondary color mapping.
 *
 * @sample com.lhzkml.jasmine.components.samples.FilledTonalButtonWithAnimatedShapeSample
 *
 * Choose the best button for an action based on the amount of emphasis it needs. The more important
 * an action is, the higher emphasis its button should be.
 * - See [Button] for a high-emphasis button without a shadow, also known as a filled button.
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.OutlinedButtonSample
 *
 * Choose the best button for an action based on the amount of emphasis it needs. The more important
 * an action is, the higher emphasis its button should be.
 * - See [Button] for a high-emphasis button without a shadow, also known as a filled button.
 ...
 * alternative, secondary action.
 *
 * @sample com.lhzkml.jasmine.components.samples.OutlinedButtonWithAnimatedShapeSample
 *
 * Choose the best button for an action based on the amount of emphasis it needs. The more important
 * an action is, the higher emphasis its button should be.
 * - See [Button] for a high-emphasis button without a shadow, also known as a filled button.
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.TextButtonWithAnimatedShapeSample
 *
 * Choose the best button for an action based on the amount of emphasis it needs. The more important
 * an action is, the higher emphasis its button should be.
 * - See [Button] for a high-emphasis button without a shadow, also known as a filled button.
 ...
 * used for the lowest priority actions, especially when presenting multiple options.
 *
 * @sample com.lhzkml.jasmine.components.samples.TextButtonSample
 *
 * Choose the best button for an action based on the amount of emphasis it needs. The more important
 * an action is, the higher emphasis its button should be.
 * - See [Button] for a high-emphasis button without a shadow, also known as a filled button.
