...
sealed interface PaneScaffoldScope {
     ...
     *
     * @sample com.lhzkml.jasmine.components.adaptive.samples.PreferredSizeModifierInDpSample
     ...
     * applied one will override all the previous settings.
     *
     * @sample com.lhzkml.jasmine.components.adaptive.samples.PreferredSizeModifierInProportionSample
     * @see PaneScaffoldDirective.defaultPanePreferredWidth
     */
