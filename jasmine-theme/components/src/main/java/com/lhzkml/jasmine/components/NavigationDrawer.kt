...
import com.lhzkml.jasmine.components.tokens.NavigationDrawerTokens
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.ModalNavigationDrawerSample
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.DismissibleNavigationDrawerSample
 * @param drawerContent content inside this drawer
 * @param modifier the [Modifier] to be applied to this drawer
 * @param drawerState state of the drawer
 * @param gesturesEnabled whether or not the drawer can be interacted by gestures
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.PermanentNavigationDrawerSample
 * @param drawerContent content inside this drawer
 * @param modifier the [Modifier] to be applied to this drawer
 * @param content content of the rest of the UI
 */
