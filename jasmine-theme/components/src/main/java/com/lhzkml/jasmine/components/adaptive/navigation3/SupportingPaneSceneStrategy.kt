 ...
 * [com.lhzkml.jasmine.components.adaptive.layout.SupportingPaneScaffold]. By using [mainPane],
...
public class SupportingPaneSceneStrategy<T : Any>(
    ...
    public companion object {
        internal const val SupportingPaneRoleKey: String =
            "com.lhzkml.jasmine.components.adaptive.layout.SupportingPaneScaffoldRole"

        /**
         * Constructs metadata to mark a [NavEntry] as belonging to a
         * [main pane][SupportingPaneScaffoldRole.Main] within a
         * [com.lhzkml.jasmine.components.adaptive.layout.SupportingPaneScaffold].
         *
