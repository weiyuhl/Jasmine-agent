...
import com.lhzkml.jasmine.components.BottomAppBarState.Companion.Saver
import com.lhzkml.jasmine.components.TopAppBarState.Companion.Saver
import com.lhzkml.jasmine.components.internal.FloatProducer
import com.lhzkml.jasmine.components.internal.ProvideContentColorTextStyle
import com.lhzkml.jasmine.components.internal.rememberAccessibilityServiceState
import com.lhzkml.jasmine.components.internal.systemBarsForVisualComponents
import com.lhzkml.jasmine.components.tokens.AppBarLargeFlexibleTokens
import com.lhzkml.jasmine.components.tokens.AppBarLargeTokens
import com.lhzkml.jasmine.components.tokens.AppBarMediumFlexibleTokens
import com.lhzkml.jasmine.components.tokens.AppBarMediumTokens
import com.lhzkml.jasmine.components.tokens.AppBarSmallTokens
import com.lhzkml.jasmine.components.tokens.AppBarTokens
import com.lhzkml.jasmine.components.tokens.BottomAppBarTokens
import com.lhzkml.jasmine.components.tokens.DockedToolbarTokens
import com.lhzkml.jasmine.components.tokens.FabSecondaryContainerTokens
import com.lhzkml.jasmine.components.tokens.MotionSchemeKeyTokens
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.SimpleTopAppBar A top app bar that uses a
 *   [scrollBehavior] to customize its nested scrolling behavior when working in conjunction with a
 *   scrolling content looks like:
 * @sample com.lhzkml.jasmine.components.samples.PinnedTopAppBar
 * @sample com.lhzkml.jasmine.components.samples.EnterAlwaysTopAppBar
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.SimpleCenterAlignedTopAppBar
 * @param title the title to be displayed in the top app bar
 * @param modifier the [Modifier] to be applied to this top app bar
 * @param navigationIcon the navigation icon displayed at the start of the top app bar. This should
 *   typically be an [IconButton] or [IconToggleButton].
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.SimpleTopAppBarWithSubtitle
 * @sample com.lhzkml.jasmine.components.samples.SimpleCenterAlignedTopAppBarWithSubtitle
 * @param title the title to be displayed in the top app bar
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.ExitUntilCollapsedMediumTopAppBar
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.ExitUntilCollapsedCenterAlignedMediumFlexibleTopAppBar
 * @param title the title to be displayed in the top app bar. This title will be used in the app
 *   bar's expanded and collapsed states, although in its collapsed state it will be composed with a
 *   smaller sized [TextStyle]
 * @param modifier the [Modifier] to be applied to this top app bar
 ...
 * working in conjunction with scrolling content looks like:
 *
 * @sample com.lhzkml.jasmine.components.samples.ExitUntilCollapsedLargeTopAppBar
 * @param title the title to be displayed in the top app bar. This title will be used in the app
 *   bar's expanded and collapsed states, although in its collapsed state it will be composed with a
 *   smaller sized [TextStyle]
 * @param modifier the [Modifier] to be applied to this top app bar
 ...
 * behavior when working in conjunction with scrolling content looks like:
 *
 * @sample com.lhzkml.jasmine.components.samples.ExitUntilCollapsedCenterAlignedLargeFlexibleTopAppBar
 * @param title the title to be displayed in the top app bar. This title will be used in the app
 *   bar's expanded and collapsed states, although in its collapsed state it will be composed with a
 *   smaller sized [TextStyle]
 * @param modifier the [Modifier] to be applied to this top app bar
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.CustomTwoRowsTopAppBar
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.SimpleBottomAppBar
 *
 * It can optionally display a [FloatingActionButton] embedded at the end of the BottomAppBar.
 *
 * @sample com.lhzkml.jasmine.components.samples.BottomAppBarWithFAB
 *
 ...
 * working in conjunction with a scrolling content looks like:
 *
 * @sample com.lhzkml.jasmine.components.samples.ExitAlwaysBottomAppBar
 *
 * Also see [NavigationBar].
 *
 * @param actions the icon content of this BottomAppBar. The default layout here is a [Row], so
 ...
 * looks like:
 *
 * @sample com.lhzkml.jasmine.components.samples.BottomAppBarWithOverflow
 * @sample com.lhzkml.jasmine.components.samples.ExitAlwaysBottomAppBarSpacedAround
 * @sample com.lhzkml.jasmine.components.samples.ExitAlwaysBottomAppBarSpacedBetween
 * @sample com.lhzkml.jasmine.components.samples.ExitAlwaysBottomAppBarSpacedEvenly
 * @sample com.lhzkml.jasmine.components.samples.ExitAlwaysBottomAppBarFixed
 * @sample com.lhzkml.jasmine.components.samples.ExitAlwaysBottomAppBarFixedVibrant
 * @param modifier the [Modifier] to be applied to this BottomAppBar
 * @param containerColor the color used for the background of this BottomAppBar. Use
 *   [Color.Transparent] to have no color.
 * @param contentColor the preferred color for content inside this BottomAppBar. Defaults to either
...
object TopAppBarDefaults {
     ...
     *
     * @sample com.lhzkml.jasmine.components.samples.PinnedTopAppBarWithPreScrolledLazyColumn
     ...
     *
     * @sample com.lhzkml.jasmine.components.samples.PinnedTopAppBarWithReversedLazyGrid
     * @param state the state object to be used to control or observe the top app bar's scroll
     *   state. See [rememberTopAppBarState] for a state that is remembered across compositions
     * @param canScroll a callback used to determine whether scroll events are to be handled by this
     *   pinned [TopAppBarScrollBehavior]
     ...
     *
     * @sample com.lhzkml.jasmine.components.samples.EnterAlwaysTopAppBarWithReverseScrolling
     * @param scrollState state of the scroll
     * @param reverseScrolling reverse the direction of scrolling, when `true`, 0
     *   [ScrollState.value] will mean bottom, when `false`, 0 [ScrollState.value] will mean top
     * @param state the state object to be used to control or observe the top app bar's scroll
...
object BottomAppBarDefaults {
    ...
    //  inaccessible. See @sample com.lhzkml.jasmine.components.samples.ExitAlwaysBottomAppBar on how
