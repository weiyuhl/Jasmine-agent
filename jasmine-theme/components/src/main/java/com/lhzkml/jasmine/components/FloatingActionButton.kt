...
import com.lhzkml.jasmine.components.MaterialTheme.LocalMaterialTheme
...
import com.lhzkml.jasmine.components.tokens.ElevationTokens
import com.lhzkml.jasmine.components.tokens.ExtendedFabLargeTokens
import com.lhzkml.jasmine.components.tokens.ExtendedFabMediumTokens
import com.lhzkml.jasmine.components.tokens.ExtendedFabPrimaryTokens
import com.lhzkml.jasmine.components.tokens.ExtendedFabSmallTokens
...
import com.lhzkml.jasmine.components.tokens.FabPrimaryContainerTokens
import com.lhzkml.jasmine.components.tokens.FabSmallTokens
import com.lhzkml.jasmine.components.tokens.MotionSchemeKeyTokens
import com.lhzkml.jasmine.components.tokens.TypographyKeyTokens
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.FloatingActionButtonSample
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.SmallFloatingActionButtonSample
 *
 * FABs can also be shown and hidden with an animation when the main content is scrolled:
 *
 * @sample com.lhzkml.jasmine.components.samples.AnimatedFloatingActionButtonSample
 * @param onClick called when this FAB is clicked
 * @param modifier the [Modifier] to be applied to this FAB
 * @param shape defines the shape of this FAB's container and shadow (when using [elevation])
 * @param containerColor the color used for the background of this FAB. Use [Color.Transparent] to
 ...
 * The FAB represents the most important action on a screen. It puts key actions within reach.
 *
 * @sample com.lhzkml.jasmine.components.samples.MediumFloatingActionButtonSample
 *
 * FABs can also be shown and hidden with an animation when the main content is scrolled:
 *
 * @sample com.lhzkml.jasmine.components.samples.AnimatedFloatingActionButtonSample
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.LargeFloatingActionButtonSample
 *
 * FABs can also be shown and hidden with an animation when the main content is scrolled:
 *
 * @sample com.lhzkml.jasmine.components.samples.AnimatedFloatingActionButtonSample
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.SmallExtendedFloatingActionButtonTextSample
 * @param onClick called when this FAB is clicked
 * @param modifier the [Modifier] to be applied to this FAB
 * @param shape defines the shape of this FAB's container and shadow (when using [elevation])
 * @param containerColor the color used for the background of this FAB. Use [Color.Transparent] to
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.MediumExtendedFloatingActionButtonTextSample
 * @param onClick called when this FAB is clicked
 * @param modifier the [Modifier] to be applied to this FAB
 * @param shape defines the shape of this FAB's container and shadow (when using [elevation])
 * @param containerColor the color used for the background of this FAB. Use [Color.Transparent] to
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.LargeExtendedFloatingActionButtonTextSample
 * @param onClick called when this FAB is clicked
 * @param modifier the [Modifier] to be applied to this FAB
 * @param shape defines the shape of this FAB's container and shadow (when using [elevation])
 * @param containerColor the color used for the background of this FAB. Use [Color.Transparent] to
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.ExtendedFloatingActionButtonTextSample
 * @param onClick called when this FAB is clicked
 * @param modifier the [Modifier] to be applied to this FAB
 * @param shape defines the shape of this FAB's container and shadow (when using [elevation])
 * @param containerColor the color used for the background of this FAB. Use [Color.Transparent] to
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.SmallExtendedFloatingActionButtonSample
 * @sample com.lhzkml.jasmine.components.samples.SmallAnimatedExtendedFloatingActionButtonSample
 ...
 * behavior, you can provide your own via [Modifier.semantics].
 *
 * @sample com.lhzkml.jasmine.components.samples.MediumExtendedFloatingActionButtonSample
 * @sample com.lhzkml.jasmine.components.samples.MediumAnimatedExtendedFloatingActionButtonSample
 * @param text label displayed inside this FAB
 * @param icon icon for this FAB, typically an [Icon]
 * @param onClick called when this FAB is clicked
 * @param modifier the [Modifier] to be applied to this FAB
 ...
 * behavior, you can provide your own via [Modifier.semantics].
 *
 * @sample com.lhzkml.jasmine.components.samples.LargeExtendedFloatingActionButtonSample
 * @sample com.lhzkml.jasmine.components.samples.LargeAnimatedExtendedFloatingActionButtonSample
 * @param text label displayed inside this FAB
 * @param icon icon for this FAB, typically an [Icon]
 * @param onClick called when this FAB is clicked
 * @param modifier the [Modifier] to be applied to this FAB
 ...
 * behavior, you can provide your own via [Modifier.semantics].
 *
 * @sample com.lhzkml.jasmine.components.samples.ExtendedFloatingActionButtonSample
 * @sample com.lhzkml.jasmine.components.samples.AnimatedExtendedFloatingActionButtonSample
 * @param text label displayed inside this FAB
 * @param icon icon for this FAB, typically an [Icon]
 * @param onClick called when this FAB is clicked
 * @param modifier the [Modifier] to be applied to this FAB
