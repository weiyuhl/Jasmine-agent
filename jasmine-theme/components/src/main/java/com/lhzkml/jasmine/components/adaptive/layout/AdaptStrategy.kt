...
sealed interface AdaptStrategy {
     ...
     *
     * @sample com.lhzkml.jasmine.components.adaptive.samples.reflowAdaptStrategySample
     ...
     *   behavior.
     * @sample com.lhzkml.jasmine.components.adaptive.samples.levitateAsBottomSheetSample
     * @sample com.lhzkml.jasmine.components.adaptive.samples.levitateAsDialogSample
