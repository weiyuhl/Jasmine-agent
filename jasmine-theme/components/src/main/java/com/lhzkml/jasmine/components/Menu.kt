...
import com.lhzkml.jasmine.components.internal.DropdownMenuPositionProvider
import com.lhzkml.jasmine.components.internal.MenuPosition
import com.lhzkml.jasmine.components.internal.MenuPosition.bottomToAnchorBottom
import com.lhzkml.jasmine.components.internal.MenuPosition.bottomToAnchorTop
import com.lhzkml.jasmine.components.internal.MenuPosition.bottomToWindowBottom
import com.lhzkml.jasmine.components.internal.MenuPosition.centerToAnchorTop
import com.lhzkml.jasmine.components.internal.MenuPosition.endToAnchorEnd
import com.lhzkml.jasmine.components.internal.MenuPosition.endToAnchorStart
import com.lhzkml.jasmine.components.internal.MenuPosition.leftToWindowLeft
import com.lhzkml.jasmine.components.internal.MenuPosition.rightToWindowRight
import com.lhzkml.jasmine.components.internal.MenuPosition.startToAnchorEnd
import com.lhzkml.jasmine.components.internal.MenuPosition.startToAnchorStart
import com.lhzkml.jasmine.components.internal.MenuPosition.topToAnchorBottom
import com.lhzkml.jasmine.components.internal.MenuPosition.topToAnchorTop
import com.lhzkml.jasmine.components.internal.MenuPosition.topToWindowTop
import com.lhzkml.jasmine.components.internal.rememberAnimatedShape
import com.lhzkml.jasmine.components.tokens.ListTokens
import com.lhzkml.jasmine.components.tokens.MotionSchemeKeyTokens
import com.lhzkml.jasmine.components.tokens.SegmentedMenuTokens
 ...
 * Example usage:
 *
 * @sample com.lhzkml.jasmine.components.samples.MenuSample
 *
 * Example usage with a [ScrollState] to control the menu items scroll position:
 *
 * @sample com.lhzkml.jasmine.components.samples.MenuWithScrollStateSample
 ...
 * Example usage:
 *
 * @sample com.lhzkml.jasmine.components.samples.GroupedMenuSample
 *
 * Example usage of cascading menus:
 *
 * @sample com.lhzkml.jasmine.components.samples.MenuWithCascadingMenusSample
 * @param expanded whether the menu is expanded or not.
 * @param onDismissRequest called when the user requests to dismiss the menu, such as by tapping
 *   outside the menu's bounds.
 * @param modifier [Modifier] to be applied to the menu's content.
 ...
 * Example usage:
 *
 * @sample com.lhzkml.jasmine.components.samples.ExposedDropdownMenuSample
...
@Deprecated("Maintained for binary compatibility.", level = DeprecationLevel.HIDDEN)
internal val DefaultMenuProperties: PopupProperties = MenuDefaults.DefaultMenuProperties
 ...
 */
@Composable
internal fun DropdownMenuPopupImpl(
    onDismissRequest: () -> Unit,
    popupPositionProvider: DropdownMenuPopupPositionProvider,
