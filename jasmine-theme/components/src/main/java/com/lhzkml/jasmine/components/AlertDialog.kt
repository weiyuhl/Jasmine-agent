...
import com.lhzkml.jasmine.components.tokens.DialogTokens
 ...
 * Simple usage:
 *
 * @sample com.lhzkml.jasmine.components.samples.AlertDialogSample
 *
 * Usage with a "Hero" icon:
 *
 * @sample com.lhzkml.jasmine.components.samples.AlertDialogWithIconSample
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.BasicAlertDialogSample
 * @param onDismissRequest called when the user tries to dismiss the Dialog by clicking outside or
 *   pressing the back button. This is not called when the dismiss button is clicked.
