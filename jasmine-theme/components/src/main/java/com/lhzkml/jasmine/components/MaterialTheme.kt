...
import com.lhzkml.jasmine.components.MotionScheme.Companion.standard
import com.lhzkml.jasmine.theme.DefaultJasmineShapes
import com.lhzkml.jasmine.theme.DefaultJasmineTypography
import com.lhzkml.jasmine.theme.JasmineColorScheme
import com.lhzkml.jasmine.theme.JasmineLightColorScheme
import com.lhzkml.jasmine.theme.JasmineShapes
import com.lhzkml.jasmine.theme.JasmineTypography
import com.lhzkml.jasmine.theme.LocalJasmineColorScheme
import com.lhzkml.jasmine.theme.LocalJasmineShapes
import com.lhzkml.jasmine.theme.LocalJasmineTypography
 ...
 *
 * @sample com.lhzkml.jasmine.components.samples.MaterialThemeSample
...
object MaterialTheme {
     ...
     *
     * @sample com.lhzkml.jasmine.components.samples.ThemeColorSample
     */
     ...
     *
     * @sample com.lhzkml.jasmine.components.samples.ThemeTextStyleSample
     */
     ...
     *
     * @sample com.lhzkml.jasmine.components.samples.ThemeShapeSample
     */
    val shapes: Shapes
    ...
    @Immutable
    class Values(
        val colorScheme: ColorScheme = JasmineLightColorScheme.toComponentColorScheme(),
        val typography: Typography = DefaultJasmineTypography.toComponentTypography(),
        val shapes: Shapes = DefaultJasmineShapes.toComponentShapes(),
 ...
 * overriding only the parts of the theme definition that need to change.
 *
 * @sample com.lhzkml.jasmine.components.samples.MaterialExpressiveThemeSample
 * @param colorScheme A complete definition of the Material Color theme for this hierarchy
...
private val _localMaterialTheme: ProvidableCompositionLocal<MaterialTheme.Values> =
    compositionLocalWithComputedDefaultOf {
        MaterialTheme.Values(
            colorScheme = LocalJasmineColorScheme.currentValue.toComponentColorScheme(),
            typography = LocalJasmineTypography.currentValue.toComponentTypography(),
            shapes = LocalJasmineShapes.currentValue.toComponentShapes(),
        )
    }

private fun JasmineColorScheme.toComponentColorScheme(): ColorScheme =
    ColorScheme(
        primary = primary,
        onPrimary = onPrimary,
        ...
        scrim = inverseSurface.copy(alpha = 0.32f),
...
private fun JasmineShapes.toComponentShapes(): Shapes =
    Shapes(
        extraSmall = extraSmall as? CornerBasedShape
            ?: RoundedCornerShape(4.dp),
        small = small as? CornerBasedShape
            ?: RoundedCornerShape(6.dp),
        medium = medium as? CornerBasedShape
            ?: RoundedCornerShape(8.dp),
        large = large as? CornerBasedShape
            ?: RoundedCornerShape(12.dp),
        extraLarge = extraLarge as? CornerBasedShape
