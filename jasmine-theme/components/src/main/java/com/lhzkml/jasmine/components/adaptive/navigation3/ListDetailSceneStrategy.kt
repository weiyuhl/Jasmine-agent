 ...
 * @sample com.lhzkml.jasmine.components.adaptive.samples.ListDetailWithNavigation3Sample
 */
 ...
 * [com.lhzkml.jasmine.components.adaptive.layout.ListDetailPaneScaffold]. By using [listPane],
...
public class ListDetailSceneStrategy<T : Any>(
    ...
    public companion object {
        internal const val ListDetailRoleKey: String =
            "com.lhzkml.jasmine.components.adaptive.layout.ListDetailPaneScaffoldRole"

        /**
         * Constructs metadata to mark a [NavEntry] as belonging to a
         * [list pane][ListDetailPaneScaffoldRole.List] within a
         * [com.lhzkml.jasmine.components.adaptive.layout.ListDetailPaneScaffold].
         *
